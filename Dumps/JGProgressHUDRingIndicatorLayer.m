...
id __cdecl -[JGProgressHUDRingIndicatorLayer actionForKey:](JGProgressHUDRingIndicatorLayer *self, SEL a2, id a3)
{
  id v4; // x19
  void *v5; // x0
  id v6; // x20
  ...
  {
    v16.receiver = self;
    v16.super_class = (Class)&OBJC_CLASS___JGProgressHUDRingIndicatorLayer;
