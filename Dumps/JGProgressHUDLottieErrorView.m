@implementation JGProgressHUDLottieErrorView

JGProgressHUDLottieErrorView *__cdecl -[JGProgressHUDLottieErrorView init](JGProgressHUDLottieErrorView *self, SEL a2)
{
  id v3; // x0
  void *v4; // x20
  __int64 v5; // x0
  ...
  void *v19; // x0
  id v20; // x21
  JGProgressHUDLottieErrorView *v21; // x19
  ...
  objc_release(v20);
  v24.receiver = self;
  v24.super_class = (Class)&OBJC_CLASS___JGProgressHUDLottieErrorView;
  v21 = -[JGProgressHUDIndicatorView initWithContentView:](&v24, "initWithContentView:", v4, v23);
  objc_release(v4);
  return v21;
}

void __cdecl -[JGProgressHUDLottieErrorView layoutSubviews](JGProgressHUDLottieErrorView *self, SEL a2)
{
  double v3; // d8
  double v4; // d1
  double v5; // d9
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___JGProgressHUDLottieErrorView;
...
LOTAnimationView *__cdecl -[JGProgressHUDLottieErrorView animation](JGProgressHUDLottieErrorView *self, SEL a2)
{
