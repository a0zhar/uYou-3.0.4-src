...
LOTCircleAnimator *__cdecl -[LOTCircleAnimator initWithInputNode:shapeCircle:](
        LOTCircleAnimator *self,
        SEL a2,
        id a3,
        id a4) {
  id v6; // x19
  ...
  v27.receiver = self;
  v27.super_class = (Class)&OBJC_CLASS___LOTCircleAnimator;
  v10 = -[LOTAnimatorNode initWithInputNode:keyName:](&v27, "initWithInputNode:keyName:", v7, v9);
  objc_release(v7);
  objc_release(v9);
  if ( v10 )
  {
...
id __cdecl -[LOTCircleAnimator valueInterpolators](LOTCircleAnimator *self, SEL a2) {
  void *v2; // x0
  id v3; // x0
...
bool __cdecl -[LOTCircleAnimator needsUpdateForFrame:](LOTCircleAnimator *self, SEL a2, id a3) {
  id v4; // x19
  char v5; // w20

  v4 = objc_retain(a3);
  if ( (sub_12D72A0(self->_centerInterpolator) & 1) != 0 )
    v5 = 1;
  else
    v5 = sub_12D72A0(self->_sizeInterpolator);
  objc_release(v4);
  return v5;
}
